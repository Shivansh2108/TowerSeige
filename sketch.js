...
function setup(){
    ...
    block20=new Block(630,145,30,40);
    block21=new Block(660,145,30,40);
    block22=new Block(690,145,30,40);
    block23=new Block(720,145,30,40);
    block24=new Block(750,145,30,40);

    block25=new Block(660,105,30,40);
    block26=new Block(690,105,30,40);
    block27=new Block(720,105,30,40);
    
    block28=new Block(690,65,30,40);
